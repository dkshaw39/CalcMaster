  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4 animate-fade-in pb-4">
      ...
      <header className="text-center pt-2 mb-2">
        <h1 className="text-xl font-bold text-slate-900">Casio <span className="text-brand-600">fx-991ES</span></h1>
      </header>

      <div className="flex justify-center">
         
         {/* Calculator Body - Reduced Width */}
         <div className="w-[300px] bg-[#e3e4e8] rounded-[24px] shadow-[0_15px_40px_-12px_rgba(0,0,0,0.3)] border border-[#d1d2d6] relative p-4 pb-6 select-none">
            ...
            <div className="bg-[#222] p-3 rounded-t-[6px] rounded-b-[16px] mb-4 shadow-md mx-1">
               <div className="bg-[#c8e0bc] h-20 shadow-[inset_0_2px_6px_rgba(0,0,0,0.2)] border border-[#888] rounded-[3px] p-2 flex flex-col justify-between font-mono relative">
                  ...
                  {/* Expression */}
                  <div className="text-sm font-medium text-black break-all leading-tight min-h-[1.5em] mt-0.5 pl-1">
                     {expression}<span className="animate-pulse opacity-50">_</span>
                  </div>

                  {/* Result */}
                  <div className="text-right text-xl font-bold text-black tracking-tight leading-none pb-0.5 pr-1">
                     {result}
                  </div>
               </div>
            </div>
